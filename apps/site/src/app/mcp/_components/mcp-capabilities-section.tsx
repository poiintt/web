...
export function McpCapabilitiesSection({
  ...
  return (
    <section className="py-element-4xl">
      <div className="mx-auto max-w-[1200px] px-4 py-10 md:px-0 md:py-12">
        ...
        <div className="mx-auto mt-6 grid max-w-[368px] grid-cols-1 gap-4 sm:max-w-none sm:grid-cols-2 xl:max-w-[1200px] xl:grid-cols-6 xl:gap-[16px]">
