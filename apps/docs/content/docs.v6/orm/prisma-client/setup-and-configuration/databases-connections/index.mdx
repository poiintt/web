...
![An AWS Lambda function connecting to a database.](/img/v6/orm/prisma-client/setup-and-configuration/databases-connections/serverless-connections.png)
...
![Three AWS Lambda function connecting to a database.](/img/v6/orm/prisma-client/setup-and-configuration/databases-connections/serverless-connections-2.png)
...
[Prisma Accelerate](/v6/accelerate) is a managed external connection pooler built by Prisma that is integrated in the [Prisma Developer Platform](/v6/platform) and handles connection pooling for you.
