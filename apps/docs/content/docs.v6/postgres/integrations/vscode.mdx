...
url: /v6/postgres/integrations/vscode
...
1. Authenticate with the [Prisma Console](https://console.prisma.io) via the popup and select a target [workspace](/v6/platform/about#workspace)
...
![VS Code command palette showing Prisma ORM version selection between version 6 and version 7.](/img/vscode/version-command-picker.png)

## Prisma Studio built-in

Beyond managing your database instances, the Prisma VS Code extension embeds Prisma Studio directly in your editor making it easy to perform create, update, delete steps on your database from right inside of VS Code. Follow these [easy steps](/v6/postgres/database/prisma-studio/studio-in-vs-code) to get started.

## Prisma MCP server

Prisma provides its own [Model Context Protocol](/v6/postgres/integrations/mcp-server) (MCP) server that lets you manage Prisma Postgres databases, model database schemas and chat through migrations.
...
- Sign in to the Prisma Developer Platform
...
4.  It automatically handles login to your Prisma Developer Platform account before proceeding.
...
:::note
Currently, the agent mode uses your default [workspace](/v6/platform/about#workspace) in the Prisma Developer Platform.
:::
