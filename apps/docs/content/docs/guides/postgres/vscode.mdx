...
1. Authenticate with the [Prisma Console](https://console.prisma.io) via the popup and select a target [workspace](/console/concepts#workspace)
...
:::note
Currently, the agent mode uses your default [workspace](/console/concepts#workspace) in the Prisma Developer Platform.
:::
