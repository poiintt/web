...
metaTitle: prisma init | Create New Prisma Project
metaDescription: 'Bootstrap a new Prisma project with prisma init. Creates schema.prisma, prisma.config.ts, .env. Choose datasource provider or provision Prisma Postgres.'
url: /cli/init
---
...
| `--db`                  | Provision a fully managed Prisma Postgres database on the Prisma Developer Platform                            |
...
This requires authentication with the [Prisma Developer Platform Console](https://console.prisma.io).
