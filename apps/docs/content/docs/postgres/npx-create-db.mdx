...
**A Prisma Developer Platform account is not required** to create a temporary database. However, if you want to keep a database permanently, you can claim it ([details below](#claiming-your-database)).
...
3. Sign in to your [Prisma Developer Platform account](https://console.prisma.io/) (or create one if you don’t have it yet).
...
- It's moved into your Prisma Developer Platform account workspace.
